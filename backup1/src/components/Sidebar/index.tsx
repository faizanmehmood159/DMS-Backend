...
import Logo from '../../images/logo/dmslogo.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
 ...
 useEffect(() => {
    // Hide the sidebar and navbar if on login or signup pages
    if (pathname === '/auth/logins' || pathname === '/auth/signups') {
      setSidebarExpanded(false);
    }
  }, [pathname]);

  if (pathname === '/auth/logins' || pathname === '/auth/signups') {
    // Return null or an empty fragment if you want to hide the sidebar and navbar
    return null;
  }
  ...
  return (
    ...
    >
      ...
      <NavLink to="/auth/Logins" className="flex items-center space-x-2 text-white font-bold">
  <img src={Logo} alt="Logo" className="w-14 h-14" />
  <h2 className="text-white font-bold">Tabib</h2>
</NavLink>
      ...
      <div className=" flex flex-col overflow-y-scroll duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
    ...
    />
              ...
              {/* <!-- Menu Item Appointment--> */}
                ...
                <SidebarLinkGroup
                activeCondition={
                  pathname === '/appointment/newappointment' || pathname.includes('appointment/newappointment')
                }
              >
                {(handleClick, open) => {
                  return (
    ...
    />
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/prescription/newprescription"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/prescription/allprescription"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
